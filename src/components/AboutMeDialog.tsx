...
function AboutMeDialog({
  ...
  return (
    ...
    >
      ...
      <p className="m-0">
        During a challenging period from 2010 to 2012, I found myself
        unemployed. However, this presented a unique opportunity for me to
        devote my time and energy to my first major project: the creation of
        TemPOS Restaurant Point of Sale software. With unwavering dedication, I
        poured countless hours into its development, building a solid foundation
        for my skills and showcasing my capabilities. Today, this project holds
        a special place in my heart and is proudly featured in my GitHub
        repository.
      </p>
      <p className="m-0">
